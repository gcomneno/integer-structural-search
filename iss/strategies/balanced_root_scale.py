...
class BalancedRootScaleSemiprimeStrategy:
    id: str = "balanced_root_scale_semiprime"
    ...
    def search(self, n: int, budget: SearchBudget) -> SearchAttempt:
        center = integer_nth_root_floor(n, 2)
        candidates_tested = 0
        prime_checks = 0
        ...
        for p in local_prime_candidates(center, budget.radius):
            ...
            return SearchAttempt(
                strategy_id=self.id,
                status="matched",
                reason="found_balanced_root_scale_semiprime_payload",
